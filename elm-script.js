...
}var $author$project$Action$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $author$project$Action$UrlChanged = function (a) {
...
var $author$project$Router$route = F2(
...
var $author$project$Helpers$packDocument = F2(
	function (title, html) {
		return {
...
var $author$project$Components$Link$addCustomAttributes = function (attributes) {
	return $elm$core$List$concat(
		_List_fromArray(
			[
				attributes,
...
var $author$project$Components$Link$default = F2(
	function (attributes, html) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$a,
			$author$project$Components$Link$addCustomAttributes(attributes),
			html);
	});
...
var $author$project$Components$Employee$employeeToAvatar = F2(
	function (size, employee) {
		return {id: employee.id, name: employee.name, size: size, url: $elm$core$Maybe$Nothing};
	});
var $author$project$Components$Employee$fontSizeFullName = function (size) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Components$Employee$fontSizeFullName(size),
...
var $author$project$Components$Avatar$baseStyles = function (avatar) {
	return $elm$core$List$concat(
		_List_fromArray(
			[
				$author$project$Components$Avatar$getBaseStylesBySize(avatar),
				_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Components$Employee$employeeToAvatar, size, employee)),
...
var $author$project$View$NewEmployee$formStyles = $rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
...
var $author$project$Components$Input$addCustomAttributes = function (attributes) {
	return $elm$core$List$concat(
		_List_fromArray(
			[
				attributes,
...
var $author$project$Components$Input$render = function (attributes) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				$author$project$Components$Input$addCustomAttributes(attributes),
				_List_Nil)
			]));
};
var $author$project$View$NewEmployee$row = function (html) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
